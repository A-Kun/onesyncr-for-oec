...
def parse():
    ...
    for line in f:
        ...
        outputfilename = "Nasa/"+p["pl_hostname"]+".xml"
        ...
        ET.SubElement(star, "mass", errorminus=p['st_masserr1'], errorplus=p['st_masserr2']).text = p["st_mass"]
        ET.SubElement(star, "temperature", errorminus=p['st_tefferr1'], errorplus=p['st_tefferr2']).text = p["st_teff"]
